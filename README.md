...
Download the exact approved package from the [MailArchive v1.0.0-rc2 release](https://github.com/dietrichailabs-oss/MailArchive/releases/tag/v1.0.0-rc2) or the [official Dietrich AI Labs download center](https://www.dietrichailabs.com/downloads.html).

Package: `MailArchive_1.0.0-rc2_Windows11_x64_Public.zip`

```text
ZIP SHA-256
12374C744CCECF5C06A5DD5182759E4977305F44602F27882EEBBE836B0D682C
...
The source published here corresponds to the approved MailArchive 1.0.0-rc2 release snapshot. MailArchive is proprietary freeware, not open-source software.
